...
filtered_df = merged_df[~merged_df["Botanical Name"].isin(["dead", "stump", "shrub", "shrubs", "vine", "vines", "hedge", "vacant"])]
...
filtered_df['Botanical Name'] = filtered_df['Botanical Name'].str.replace("Ã—", "", regex=False)\
    .replace("Ã", "", regex=False)\
    .replace("_x000d_", "", regex=False)\
    .replace("â€˜", "", regex=False)\
    .replace("â€™", "", regex=False)\
    .replace("'", "", regex=False)
