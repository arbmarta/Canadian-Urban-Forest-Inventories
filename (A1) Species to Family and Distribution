...
# Import datasets
df_names = pd.read_csv("wcvp_names.csv", sep="|", header=0, quoting=3, encoding="utf-8", keep_default_na=False)
df_distribution = pd.read_csv("wcvp_distribution.csv", sep="|", header=0, quoting=3, encoding="utf-8", keep_default_na=False)
...
filtered_df = merged_df[merged_df['area_code_l3'].isin(codes_to_keep)]
