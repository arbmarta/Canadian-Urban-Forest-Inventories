...
# Function to count unique cities for each taxon where it appears at least 30 times
def count_unique_cities_for_taxa_min_count(df, column, taxa_list, min_count=30):
    city_counts = {}
...
# Count unique cities where species, genus, and family appear at least 30 times
...
# Print the results
print("Top 10 Species and the number of cities where they appear at least 30 times:")
for species, count in species_city_counts.items():
    print(f"{species}: {count} cities")

print("\nTop 10 Genus and the number of cities where they appear at least 30 times:")
for genus, count in genus_city_counts.items():
    print(f"{genus}: {count} cities")

print("\nTop 10 Family and the number of cities where they appear at least 30 times:")
